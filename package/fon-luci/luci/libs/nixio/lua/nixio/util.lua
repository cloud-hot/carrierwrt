...
if posix and posix.uname("%r"):sub(1, 6) == "2.6.21" then
	function nixio.splice(fdin, fdout, size)
		local data, code, msg = fdin:read(size)
		if data and #data > 0 then
			data, code, msg = fdout:writeall(data)
			return data, code, msg
		else
			return data and 0, code, msg
		end
	end
end
